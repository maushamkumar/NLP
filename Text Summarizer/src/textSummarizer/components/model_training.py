...
class ModelTrainer:
    ...
    def train(self):
        ...
        model_pegasus = AutoModelForSeq2SeqLM.from_pretrained(self.config.model_ckpt, torch_dtype=torch.float16).to(device)
        model = model_pegasus.gradient_checkpointing_enable()
